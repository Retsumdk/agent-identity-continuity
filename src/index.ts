#!/usr/bin/env bun
/**
 * agent-identity-continuity - Cryptographic identity verification for AI agents across sessions with attestation and drift detection
...
program.name("agent-identity-continuity").description("Cryptographic identity verification for AI agents across sessions with attestation and drift detection").version("1.0.0")
